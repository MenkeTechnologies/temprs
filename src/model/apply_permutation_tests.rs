...
#[test]
fn apply_permutation_n160_full_reverse() {
    let n = 160;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i128> = (0..n as i128).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n as i128).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n164_full_reverse() {
    let n = 164;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i16> = (0..n as i16).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n as i16).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n168_full_reverse() {
    let n = 168;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u128> = (0..n as u128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n172_full_reverse() {
    let n = 172;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i32> = (0..n as i32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n176_full_reverse() {
    let n = 176;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u8> = (0..n as u8).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n180_full_reverse() {
    let n = 180;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u16> = (0..n as u16).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n184_full_reverse() {
    let n = 184;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<usize> = (0..n).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n188_full_reverse() {
    let n = 188;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i128> = (0..n as i128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n192_full_reverse() {
    let n = 192;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u128> = (0..n as u128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n196_full_reverse() {
    let n = 196;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i64> = (0..n as i64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n200_full_reverse() {
    let n = 200;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u64> = (0..n as u64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n204_full_reverse() {
    let n = 204;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<isize> = (0..n as isize).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n208_full_reverse() {
    let n = 208;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i32> = (0..n as i32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n212_full_reverse() {
    let n = 212;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u32> = (0..n as u32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n216_full_reverse() {
    let n = 216;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i16> = (0..n as i16).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n220_full_reverse() {
    let n = 220;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u16> = (0..n as u16).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n224_full_reverse() {
    let n = 224;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i128> = (0..n as i128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n228_full_reverse() {
    let n = 228;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u128> = (0..n as u128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n232_full_reverse() {
    let n = 232;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i32> = (0..n as i32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n236_full_reverse() {
    let n = 236;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u64> = (0..n as u64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n240_full_reverse() {
    let n = 240;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<isize> = (0..n as isize).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n244_full_reverse() {
    let n = 244;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<usize> = (0..n).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n248_full_reverse() {
    let n = 248;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i128> = (0..n as i128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n252_full_reverse() {
    let n = 252;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u128> = (0..n as u128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n256_full_reverse() {
    let n = 256;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u16> = (0..n).map(|i| i as u16).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n).map(|i| i as u16).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n260_full_reverse() {
    let n = 260;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i32> = (0..n as i32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n264_full_reverse() {
    let n = 264;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u64> = (0..n as u64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n268_full_reverse() {
    let n = 268;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i64> = (0..n as i64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n272_full_reverse() {
    let n = 272;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f32> = (0..n).map(|i| i as f32).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n).map(|i| i as f32).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n276_full_reverse() {
    let n = 276;
    let perm: Vec<usize> = (0..n).rev().collect();
...
#[test]
fn apply_permutation_n280_full_reverse() {
    let n = 280;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i16> = (0..n).map(|i| i as i16).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n).map(|i| i as i16).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n284_full_reverse() {
    let n = 284;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u16> = (0..n).map(|i| i as u16).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n288_full_reverse() {
    let n = 288;
    let perm: Vec<usize> = (0..n).rev().collect();
...
#[test]
fn apply_permutation_n292_full_reverse() {
    let n = 292;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i128> = (0..n).map(|i| i as i128).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n).map(|i| i as i128).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n296_full_reverse() {
    let n = 296;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u128> = (0..n).map(|i| i as u128).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n).map(|i| i as u128).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n300_full_reverse() {
    let n = 300;
    let perm: Vec<usize> = (0..n).rev().collect();
...
#[test]
fn apply_permutation_n304_full_reverse() {
    let n = 304;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<isize> = (0..n).map(|i| i as isize).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n).map(|i| i as isize).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n308_full_reverse() {
    let n = 308;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<usize> = (0..n).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n312_full_reverse() {
    let n = 312;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i32> = (0..n).map(|i| i as i32).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n).map(|i| i as i32).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n316_full_reverse() {
    let n = 316;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u64> = (0..n).map(|i| i as u64).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n).map(|i| i as u64).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n320_full_reverse() {
    let n = 320;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i64> = (0..n).map(|i| i as i64).collect();
    apply_permutation(&mut v, &perm);
    assert_eq!(v, (0..n).map(|i| i as i64).rev().collect::<Vec<_>>());
}

#[test]
fn apply_permutation_n324_full_reverse() {
    let n = 324;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f32> = (0..n).map(|i| i as f32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n328_full_reverse() {
    let n = 328;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f64> = (0..n).map(|i| i as f64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n332_full_reverse() {
    let n = 332;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i128> = (0..n).map(|i| i as i128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n336_full_reverse() {
    let n = 336;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u128> = (0..n).map(|i| i as u128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n340_full_reverse() {
    let n = 340;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i16> = (0..n).map(|i| i as i16).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n344_full_reverse() {
    let n = 344;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u16> = (0..n).map(|i| i as u16).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n348_full_reverse() {
    let n = 348;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u32> = (0..n).map(|i| i as u32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n352_full_reverse() {
    let n = 352;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f32> = (0..n).map(|i| i as f32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n356_full_reverse() {
    let n = 356;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f64> = (0..n).map(|i| i as f64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n360_full_reverse() {
    let n = 360;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i64> = (0..n).map(|i| i as i64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n364_full_reverse() {
    let n = 364;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u64> = (0..n).map(|i| i as u64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n368_full_reverse() {
    let n = 368;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<usize> = (0..n).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n372_full_reverse() {
    let n = 372;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i128> = (0..n).map(|i| i as i128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n376_full_reverse() {
    let n = 376;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u128> = (0..n).map(|i| i as u128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n380_full_reverse() {
    let n = 380;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<isize> = (0..n).map(|i| i as isize).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n384_full_reverse() {
    let n = 384;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<char> = (0..n)
        .map(|i| char::from_u32(i as u32).expect("Unicode scalar"))
...
#[test]
fn apply_permutation_n388_full_reverse() {
    let n = 388;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f32> = (0..n).map(|i| i as f32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n392_full_reverse() {
    let n = 392;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f64> = (0..n).map(|i| i as f64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n396_full_reverse() {
    let n = 396;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i32> = (0..n).map(|i| i as i32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n400_full_reverse() {
    let n = 400;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u32> = (0..n).map(|i| i as u32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n404_full_reverse() {
    let n = 404;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u16> = (0..n).map(|i| i as u16).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n408_full_reverse() {
    let n = 408;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i16> = (0..n).map(|i| i as i16).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n412_full_reverse() {
    let n = 412;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<isize> = (0..n).map(|i| i as isize).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n416_full_reverse() {
    let n = 416;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u128> = (0..n).map(|i| i as u128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n420_full_reverse() {
    let n = 420;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i128> = (0..n).map(|i| i as i128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n424_full_reverse() {
    let n = 424;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u64> = (0..n).map(|i| i as u64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n428_full_reverse() {
    let n = 428;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i64> = (0..n).map(|i| i as i64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n432_full_reverse() {
    let n = 432;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i32> = (0..n).map(|i| i as i32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n436_full_reverse() {
    let n = 436;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f64> = (0..n).map(|i| i as f64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n444_full_reverse() {
    let n = 444;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u32> = (0..n).map(|i| i as u32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n448_full_reverse() {
    let n = 448;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<isize> = (0..n).map(|i| i as isize).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n452_full_reverse() {
    let n = 452;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f32> = (0..n).map(|i| i as f32).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n456_full_reverse() {
    let n = 456;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<f64> = (0..n).map(|i| i as f64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n460_full_reverse() {
    let n = 460;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u128> = (0..n).map(|i| i as u128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n464_full_reverse() {
    let n = 464;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i128> = (0..n).map(|i| i as i128).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n468_full_reverse() {
    let n = 468;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<u64> = (0..n).map(|i| i as u64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n472_full_reverse() {
    let n = 472;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<i64> = (0..n).map(|i| i as i64).collect();
    apply_permutation(&mut v, &perm);
...
#[test]
fn apply_permutation_n480_full_reverse() {
    let n = 480;
    let perm: Vec<usize> = (0..n).rev().collect();
    let mut v: Vec<usize> = (0..n).collect();
    apply_permutation(&mut v, &perm);
