...
mod tests {
    ...
    fn flag_constants_are_unique() {
        let flags = vec![
            ...
            LIST_CONTENTS, LIST_CONTENTS_NUMBERED, CLEAR, SHIFT, SILENT, EDIT, TAG, RENAME, INFO, GREP, CAT, COUNT, DIFF, MOVE, DUP, SWAP, APPEND, REVERSE, EXPIRE, HEAD, TAIL, WC, SIZE, SORT,
        ];
